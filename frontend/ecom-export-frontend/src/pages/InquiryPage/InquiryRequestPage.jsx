...
export default function InquiryRequestPage() {
    ...
    return (
        <div className="inquiry-page container py-5">
            <Header />
            {/* Logo */}
            ...
            <div className="row g-5 align-items-start">
                ...
                <div className="col-lg-5 text-center product-section">
                    <img
                        src={sampleImage}
                        alt="Product"
                        className="product-preview-img shadow-sm zoom-on-hover"
                    />
                    <h4 className="fw-bold mt-3">{formData.product}</h4>
                    <p className="text-muted">
                        Freshly harvested, export-grade mangoes with rich flavor and natural sweetness.
                        Ideal for international markets and premium retail stores.
                    </p>
                </div>
                ...
                <div className="col-lg-7">
                    <div className="form-container shadow-lg p-4 rounded-4 bg-white">
                        <h3 className="mb-4 text-primary">Inquiry Form</h3>
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="btn btn-primary w-100 py-2 submit-btn">
                                Submit Inquiry
                            </button>
                        </form>
                    </div>
